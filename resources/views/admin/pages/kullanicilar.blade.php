                                ...
                                <tbody>
                                   @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td> <button class="btn btn-success waves-effect" type="button" onclick="location.href='{{ url('/admin/kullanici-duzenle/'.$user->id) }}'">
                                                    <i class="material-icons">Düzenle</i>
                                                </button> /  <button class="btn btn-danger waves-effect" type="button" onclick="deleteTag({{ $user->id }})">
