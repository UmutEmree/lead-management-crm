                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-example-wrap mg-t-30">
                        <div class="cmp-tb-hd cmp-int-hd">
                           ...
                           <form action="{{ route('admin.marka-duzenlePost',$brand->id) }}" method="post">
                            {{ csrf_field() }}
                        {{ method_field('PUT') }}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" name="name" value="{{ $brand->name }}" required class="form-control input-sm" placeholder="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <select name="sector" required class="selectpicker" data-live-search="true">
                                            ...
                                            <option value="{{ $sector->id }}" {{ $brand->sector == $sector->id ? 'selected' : '' }}>{{ $sector->name }}</option>
                                            @endforeach
                        ...
                        <div class="form-example-int form-horizental mg-t-15">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" name="limit" value="{{ $brand->limit }}"  class="form-control input-sm" placeholder="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-example-int mg-t-15">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                    <button type="submit" class="btn btn-success notika-btn-success">Güncelle</button>
                                </div>
                            </div>
                        </div>
                        </form>
